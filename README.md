...
사원, 공급업체, 품목, 계약, 입출고 등 자재와 계약 흐름을 관리하며,
품목 입고/출고/검수 등의 기능을 포함한 **기업형 ERP 시스템**을 구현한 실전 프로젝트 입니다.
...
|        개발 형태          |    팀 프로젝트                                                  |
|        담당 역할          |    DB 설계, 로그인 구현, 품목/공급업체/계약/재고관리 UI                 |
